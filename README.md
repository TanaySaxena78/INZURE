...
Simply double-click `dashboard.html` to open the application in your default web browser or open this link : 'tanaysaxena78.github.io/INZURE/dashboard.html'
